...
// Imprint Component with Language Selection
const Imprint = () => {
  const [language, setLanguage] = useState<'en' | 'de'>('en')

  const title = language === 'en' ? 'Imprint' : 'Impressum'
...
// Privacy Policy Component with Language Selection
const Privacy = () => {
  const [language, setLanguage] = useState<'en' | 'de'>('en')

  const title = language === 'en' ? 'Privacy Policy' : 'Datenschutzerklärung'
...
// Terms Component with Language Selection
const Terms = () => {
  const [language, setLanguage] = useState<'en' | 'de'>('en')

  const title = language === 'en' ? 'Terms of Service' : 'Nutzungsbedingungen'
